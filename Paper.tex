...
%-----% CHAPTER ONE %----------------------------%
 ...
 \lipsum[9]\marginpar{\footnotesize\textit{Here is a margin note which can float and drop down.}}

 \subsubsection{And here is a sub-sub-section...}
 \lipsum[10]\marginpar{\(x\quad z\)}            % Introduce your variables in the margins!
